...
![[image/Attachments 3/Procédures_utilisateurs_GLPI.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI.jpeg]]

4. Télécharger l'agent (remplacer l'URL par le lien copié) :
```plain text
wget <lien-copié>
```
![[image/Attachments 3/Procédures_utilisateurs_GLPI 1.jpeg]]
![[image/Attachments 3/Procédures_utilisateurs_GLPI 2.jpeg]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 3.jpeg]]

7. Appuyer sur **Entrée** pour conserver la configuration par défaut

![[image/Attachments 3/Procédures_utilisateurs_GLPI 4.jpeg]]

L'agent est maintenant installé.

![[image/Attachments 3/Procédures_utilisateurs_GLPI 5.jpeg]]
...
```
![[image/Attachments 3/Procédures_utilisateurs_GLPI 8.png]]
...
```
![[image/Attachments 3/Procédures_utilisateurs_GLPI 6.jpeg]]
11. Déclencher un inventaire manuellement pour tester :
```plain text
sudo glpi-agent --force
```
![[image/Attachments 3/Procédures_utilisateurs_GLPI 7.jpeg]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 8.jpeg]]

2. Lancer l'installation et renseigner l'URL du serveur GLPI pour faire remonter l'inventaire

![[image/Attachments 3/Procédures_utilisateurs_GLPI 9.jpeg]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 10.jpeg]]
...
```
![[image/Attachments 3/Procédures_utilisateurs_GLPI 11.jpeg]]

5. Cliquer sur **« Force an inventory »** pour vérifier que l'agent est opérationnel et pointe bien vers le serveur GLPI

![[image/Attachments 3/Procédures_utilisateurs_GLPI 12.jpeg]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 1.png]]

Sélectionner ensuite le type d'élément à administrer dans le menu déroulant (ex. : **Ordinateurs**) :

![[image/Attachments 3/Procédures_utilisateurs_GLPI 2.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 3.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 4.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 5.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 6.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 13.jpeg]]

2. Lancer l'installation

![[image/Attachments 3/Procédures_utilisateurs_GLPI 14.jpeg]]

3. Cliquer sur **« Paramètres »**, renseigner l'URL du serveur GLPI, puis cliquer sur **« Enregistrer »**

![[image/Attachments 3/Procédures_utilisateurs_GLPI 15.jpeg]]

4. Cliquer sur **« Forcer l'inventaire »** pour tester

![[image/Attachments 3/Procédures_utilisateurs_GLPI 16.jpeg]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 9.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 10.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 11.png]]
![[image/Attachments 3/Procédures_utilisateurs_GLPI 12.png]]
...
![[image/Attachments 3/Procédures_utilisateurs_GLPI 13.png]]

Le contenu de l'article s'affiche :

![[image/Attachments 3/Procédures_utilisateurs_GLPI 14.png]]
